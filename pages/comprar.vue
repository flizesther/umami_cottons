<template>
  <b-container-fluid class="comprar">
    <div class="d-flex flex-column py-4">
      ...
      <div class="text">
        No queremos que tu compra sea con un carrito y chin pum, queremos que contactes con nosotras, que nos digas qué
        es lo que quieras, que elijas tu tela, que nos digas que nombre poner en la caja y así poder hacer un trato más
        cercano. Sí, compras por internet, pero no nos olvidemos de lo qué es umami no es comprar por comprar, es
        comprar calidad, arte y cositas hechas con mucho amor.
      </div>
    </div>
