<template>
  <b-container-fluid class="home">
    <div class="promotional-slider">Pedidos de más de 50 euros, los gastos de envío son gratuitos!</div>
    ...
    ></b-img>
    <div class="py-4 d-flex justify-content-center subtitle-section">Nuestros productos</div>
    ...
    <div class="d-flex justify-content-center mobile-grid">
      ...
      <b-button v-b-modal.modal-center-6 class="d-none d-lg-block">
        ...
        <b-modal id="modal-center-6" hide-footer centered title="Un pack lo arregla todo">
          <p class="py-4">
            A veces no sabes qué tienes que comprar o regalar. Un pack te cambia la vida! mira las posibles
            combinaciones
          </p>
        </b-modal>
      </b-button>
    ...
    <div class="d-flex justify-content-center pb-4 mobile-grid">
      <b-button v-b-modal.modal-center-7 class="d-none d-lg-block">
        ...
        <b-modal id="modal-center" hide-footer centered title="Sobre de muda">
          <p class="py-4">
            Producto estrella. Ten todo organizado. Uno sabe lo ordenado con lo que sale, pero no como llega. Con los
            sobres de muda, la organización está garantizada!
          </p>
        </b-modal>
      </b-button>
      ...
      <b-button v-b-modal.modal-center-9 class="d-none d-lg-block">
        ...
        <b-modal id="modal-center" hide-footer centered title="Disfrutar con umami">
          <p class="py-4">
            Disfruta de cada momento con tu bebé, sobre todo del baño, para eso umami está aquí para ayudarte a
    ...
    <b-button href="/comprar" class="py-4 mt-4 w-100 d-lg-none d-flex justify-content-center buy-section"
